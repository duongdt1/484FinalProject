...
public partial class dashboard_Agriculture__Food__and_Natural_Resources : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        String search = "select count(jobid)AS 'Nbr of jobs in CareerCluster',job.careercluster from job " +
            "inner join organization on job.[OrganizationID] = Organization.[OrganizationID] group by job.careercluster having job.careercluster = 'Agriculture, Food, and Natural Resources'";
