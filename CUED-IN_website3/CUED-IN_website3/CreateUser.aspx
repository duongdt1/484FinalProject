<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CreateUser.aspx.cs" Inherits="CreateUser" MaintainScrollPositionOnPostback="true"%>
  ...
  <head>
	...
	<form runat= "server">
        ...
        <div class="form-group">
            ...
            <asp:RegularExpressionValidator ForeColor="Red" runat="server" ControlToValidate="txtPassword" ValidationExpression="(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[^\da-zA-Z]).{8,15}$" Display="Dynamic" ErrorMessage="Password must between 8 and 15 characters, have both letters, numbers, a special character, and a capitalized letter." />
